    ...
    <div className={styles.main}>
      ...
      <div className={styles.mainContainer}>
        ...
        <p>
          ...
          agencies or our regulators based on their requirement (if any) to
          comply with the applicable laws including cyber laws.<br></br>
          <br></br>
          ...
          behalf for successful and efficient delivery of Services. (eg. sending
          emails or newsletters to users). <br></br>
          <br></br>
        </p>{" "}
        <br></br> <br></br>
